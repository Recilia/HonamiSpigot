...
public final class SimplePluginManager implements PluginManager {
	...
	public synchronized Plugin loadPlugin(File file) throws InvalidPluginException, UnknownDependencyException {
		...
		if (result != null) {
			plugins.add(result);
			lookupNames.put(result.getDescription().getName().toLowerCase(), result); 
		}
	...
	public synchronized Plugin getPlugin(String name) {
		return lookupNames.get(name.replace(' ', '_').toLowerCase()); 
	}
	...
	public void registerEvent(Class<? extends Event> event, Listener listener, EventPriority priority,
		...
		executor = new co.aikar.timings.TimedEventExecutor(executor, plugin, null, event); 
	...
	public void useTimings(boolean use) {
		co.aikar.timings.Timings.setTimingsEnabled(use); 
	}
}
