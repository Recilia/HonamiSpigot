...
public class SearchHandler {
	...
	private final ExecutorService executor = Executors.newFixedThreadPool(HonamiConfig.pathSearchThreads,
			new ThreadFactoryBuilder().setNameFormat("Honami Entity Path Search Thread %d").build());
