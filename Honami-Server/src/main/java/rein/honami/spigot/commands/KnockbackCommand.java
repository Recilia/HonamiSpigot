...
import rein.honami.spigot.commons.ClickableBuilder;
import rein.honami.spigot.knockback.CraftKnockbackProfile;
...
public class KnockbackCommand extends Command {
	...
	public KnockbackCommand(String name) {
		...
		this.setPermission("honami.command.knockback");
	}
