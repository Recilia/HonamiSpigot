	...
	public void t_() {
		...
		if (this.az > 0) {
			...
			if (!this.as) {
				...
				motX *= HonamiConfig.fishingRodMultiplier;
				motY *= HonamiConfig.fishingRodMultiplier;
				motZ *= HonamiConfig.fishingRodMultiplier;
					...
					if (this.av > 0) {
						...
						if (this.ax > 0) {
							...
							this.aw = MathHelper.nextInt(this.random, this.world.paperSpigotConfig.fishingMinTicks,
									this.world.paperSpigotConfig.fishingMaxTicks); 
