...
import rein.honami.spigot.taco.event.entity.SpawnerPreSpawnEvent;
...
public abstract class MobSpawnerAbstract {
	...
	public MobSpawnerAbstract() {
		...
		this.spawnDelay = HonamiConfig.spawnersInitialSpawnDelay;
		this.minSpawnDelay = HonamiConfig.spawnersMinSpawnDelay;
		this.maxSpawnDelay = HonamiConfig.spawnersMaxSpawnDelay;
		this.spawnCount = HonamiConfig.spawnersSpawnCount;
		this.spawnRange = HonamiConfig.spawnersSpawnRange;
		this.maxNearbyEntities = HonamiConfig.spawnersMaxNearbyEntities;
		this.requiredPlayerRange = HonamiConfig.spawnersRequiredPlayerRange;
	...
	public void c() {
		...
		if (this.g()) {
			...
			if (this.a().isClientSide) {
				...
				if (HonamiConfig.spawnerAnimation) {
