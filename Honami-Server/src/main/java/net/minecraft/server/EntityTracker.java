...
import rein.honami.spigot.commons.ConcurrentIntHashMap;
import rein.honami.spigot.config.HonamiConfig;

import rein.honami.spigot.playermap.utils.IndexedLinkedHashSet;

public class EntityTracker {

	public Set<EntityTrackerEntry> c = new IndexedLinkedHashSet<>();
	
	public IntHashMap<EntityTrackerEntry> trackedEntities = new ConcurrentIntHashMap<>(); 

	private volatile int noTrackDistance = 0; 
	...
	public void addEntity(Entity entity, int i, final int j, boolean flag) {
		...
		try {
			...
			EntityTrackerEntry entitytrackerentry = createTracker(entity, i, j, flag); 
	...
	protected EntityTrackerEntry createTracker(Entity entity, int i, int j, boolean flag) { 
		if (entity.isCannoningEntity && HonamiConfig.useFasterCannonTracker) {
			return new rein.honami.spigot.visuals.CannonTrackerEntry(this, entity, i, j, flag);
		} else {
	...
	public void untrackEntity(Entity entity) {
		org.spigotmc.AsyncCatcher.catchOp("entity untrack"); 
		if (entity instanceof EntityPlayer) {
