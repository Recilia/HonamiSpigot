...
public abstract class Entity implements ICommandListener {
	...
	public boolean isCannoningEntity; 
	...
	public Entity(World world) {
		...
		this.isCannoningEntity = this instanceof EntityTNTPrimed || this instanceof EntityFallingBlock; 
	...
	public void move(double d0, double d1, double d2) {
		...
		if (this.noclip) {
			...
			boolean axisScan = this.world.honamiTacoConfig.optimizeTntMovement && xLength * yLength * zLength > 10;
			...
			if (this.world.honamiTacoConfig.fixEastWest && Math.abs(d0) > Math.abs(d2)) { 

																							
																							
				if (axisScan) {
					list = this.world.getCubes(this, this.getBoundingBox().a(0, 0, d2)); 
				...
				if (axisScan) {
					list = this.world.getCubes(this, this.getBoundingBox().a(d0, 0, 0)); 
	...
	public void c(int i) {
		if (!this.world.isClientSide && !this.dead) {
			...
			TravelAgent agent = exit != null ? (TravelAgent) ((CraftWorld) exit.getWorld()).getHandle().getTravelAgent()
					: org.bukkit.craftbukkit.CraftTravelAgent.DEFAULT; 
