...
public class WorldMap extends PersistentBase {
	...
	public Map<EntityHuman, WorldMap.WorldMapHumanTracker> i = Maps.newHashMap(); 
	public Map<UUID, MapIcon> decorations = Maps.newLinkedHashMap(); 
	private org.bukkit.craftbukkit.map.RenderData vanillaRender = new org.bukkit.craftbukkit.map.RenderData(); 
	...
	public void a(EntityHuman entityhuman, ItemStack itemstack) {
			...
			if (!worldmap_worldmaphumantracker1.trackee.dead
				...
				if (!itemstack.y() && worldmap_worldmaphumantracker1.trackee.dimension == this.map) {
					this.a(0, worldmap_worldmaphumantracker1.trackee.world,
							...
							worldmap_worldmaphumantracker1.trackee.yaw); 
				}
			} else {
		...
		if (itemstack.y()) {
			...
			this.a(1, entityhuman.world,
					...
					blockposition.getX(), blockposition.getZ(), entityitemframe.direction.b() * 90); 
		}
	...
	public class WorldMapHumanTracker {
		...
		public Packet<?> a(ItemStack itemstack) {
			...
			org.bukkit.craftbukkit.map.RenderData render = !vanillaMaps
					...
					: WorldMap.this.vanillaRender; 

			java.util.Collection<MapIcon> icons = new java.util.ArrayList<MapIcon>();
			if (vanillaMaps) {
				addSeenPlayers(icons); 
			}
