...
import rein.honami.spigot.taco.HopperHelper; 
...
public class TileEntityHopper extends TileEntityContainer implements IHopper, IUpdatePlayerListBox {
	...
	public boolean m() {
		if (this.world != null && !this.world.isClientSide) {
			...
			if (world.paperSpigotConfig.useHopperCheck && !world.honamiTacoConfig.isHopperPushBased && !this.n()) { 
				...
				for (int i = 0; i < this.getSize(); ++i) {
					if (this.getItem(i) != null) {
						...
						CraftItemStack oitemstack = CraftItemStack
								.asCraftMirror(this.splitStack(i, world.spigotConfig.hopperAmount)); 
	...
	public static boolean a(IHopper ihopper) {
		...
		if (ihopper.getWorld().honamiTacoConfig.isHopperPushBased && ihopper instanceof TileEntityHopper) {
			BlockPosition pos = ((TileEntityHopper) ihopper).getPosition().up(); 
	...
	public static boolean acceptItem(IHopper ihopper, IInventory iinventory) {
		...
		} else if (!ihopper.getWorld().honamiTacoConfig.isHopperPushBased || !(ihopper instanceof TileEntityHopper)) { 
	...
	private static boolean a(IHopper ihopper, IInventory iinventory, int i, EnumDirection enumdirection) {
		...
		if (itemstack != null && b(iinventory, itemstack, i, enumdirection)) {
			...
			CraftItemStack oitemstack = CraftItemStack
					.asCraftMirror(iinventory.splitStack(i, ihopper.getWorld().spigotConfig.hopperAmount)); 
