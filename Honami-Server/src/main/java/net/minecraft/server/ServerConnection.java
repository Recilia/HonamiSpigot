...
import rein.honami.spigot.protocol.MinecraftPipeline;
...
public class ServerConnection {
	...
	public void a(InetAddress ip, int port) throws IOException {
		synchronized (this.getListeningChannels()) {
			...
			LOGGER.info("Honami: Using " + Natives.compress.getLoadedVariant() + " compression from Velocity.");
			LOGGER.info("Honami: Using " + Natives.cipher.getLoadedVariant() + " cipher from Velocity.");
