...
public class Chunk {
	...
	protected it.unimi.dsi.fastutil.objects.Object2IntOpenHashMap<Class> entityCount = new it.unimi.dsi.fastutil.objects.Object2IntOpenHashMap<>(); 
	...
	public Chunk(World world, int i, int j) {
		...
		for (int k = 0; k < this.entitySlices.length; ++k) {
			this.entitySlices[k] = new io.papermc.paper.util.maplist.ObjectMapList<>(); 
	...
	public void loadNearby(IChunkProvider ichunkprovider, IChunkProvider ichunkprovider1, int i, int j) {
		world.timings.syncChunkLoadPostTimer.startTiming(); 
		...
		world.timings.syncChunkLoadPostTimer.stopTiming(); 
	}
	...
	public void b(boolean flag) {
		if (this.k && !this.world.worldProvider.o() && !flag) {
			this.recheckGaps(this.world.isClientSide); 
		}
