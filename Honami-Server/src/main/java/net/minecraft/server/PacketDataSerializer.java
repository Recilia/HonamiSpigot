...
import rein.honami.spigot.taco.CompatHacks;
...
public class PacketDataSerializer extends ByteBuf {
    ...
    public int readVarInt() { return e(); } 
    public int e() {
        byte b0;
        int i = 0;
        int j = 0;
    ...
    public UUID readUUID() { return g(); } 

    public UUID g() {
        return new UUID(this.readLong(), this.readLong());
    }

    public void writeVarInt(int value) { this.b(value); } 
    ...
    public String readUUID(int maxLength) { return c(maxLength); } 
