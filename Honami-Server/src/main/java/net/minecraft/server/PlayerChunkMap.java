...
public class PlayerChunkMap {
	...
	private final Queue<PlayerChunkMap.PlayerChunk> e = new java.util.concurrent.ConcurrentLinkedQueue<>(); 

																											

	private final Queue<PlayerChunkMap.PlayerChunk> f = new java.util.concurrent.ConcurrentLinkedQueue<>(); 
	...
	class PlayerChunk {
		...
		public PlayerChunk(int i, int j) {
			...
			PlayerChunkMap.this.a().chunkProviderServer.getChunkAt(i, j, loadedRunnable); 
		}
