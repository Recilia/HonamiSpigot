...
import rein.honami.spigot.vanish.VanishPatch;
...
public class EntityTrackerEntry {
	...
	public void broadcast(Packet packet) {
		...
		while (iterator.hasNext()) {
			...
			if (!VanishPatch.shouldShowEntityToPlayer(entityplayer.getBukkitEntity(), this.tracker.getBukkitEntity())) {
				continue;
			}
	...
	public void clear(EntityPlayer entityplayer) {
		org.spigotmc.AsyncCatcher.catchOp("player tracker clear"); 
