	...
	public static void main(String[] args) {
		...
		OptionParser parser = new OptionParser() {
			{
				...
				acceptsAll(asList("honami-taco", "honami-taco-settings"), "File for honami taco settings").withRequiredArg()
						.ofType(File.class).defaultsTo(new File("honami-taco.yml")).describedAs("Yml file");
				...
				acceptsAll(asList("honami", "honami-settings"), "File for honami settings").withRequiredArg()
				.ofType(File.class).defaultsTo(new File("honami.yml")).describedAs("Yml file");
		...
		if ((options == null) || (options.has("?"))) {
			...
			try {
				...
				if (useJline) {
					System.setProperty("library.jansi.version", "Honami");
				...
				rein.honami.spigot.taco.HonamiTacoConfig.init((File) options.valueOf("honami-taco-settings")); 
